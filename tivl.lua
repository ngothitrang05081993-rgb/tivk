--[[
    BANANA CAT HUB - MOBILE VERSION
    Đã gộp Logic Auto Farm + GUI
]]
...
local Settings = {
    FarmLevel = false,
    FarmNearest = false,
    SelectedWeapon = "Melee", -- Mặc định là Melee (Võ)
    ...
    FlySpeed = 300,        
    FarmDistance = 5 -- Khoảng cách đứng đánh (5m cho gần)
}

-- --- HÀM TẠO HIGHLIGHT (ĐÁNH DẤU QUÁI) ---
